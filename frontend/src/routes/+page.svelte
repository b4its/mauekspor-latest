...
<div class="landing-font min-h-svh bg-[#f4f8ff] text-[#0b1d3a] dark:bg-[#040d1f] dark:text-[#eaf1ff]">
	<div class="mx-auto grid max-w-7xl gap-6 p-4 sm:p-5">
		...
		>
			<a class="inline-flex items-center gap-2.5 font-display font-black" href="/">
				<span class="grid size-9 place-items-center rounded-xl bg-gradient-to-br from-[#0b3d91] to-[#1e63d6] font-black tracking-tighter text-white">
		...
		<footer class="flex flex-wrap items-center justify-between gap-4 px-2 py-6 text-sm text-[#0b1d3a]/60 dark:text-white/60">
			<div class="inline-flex items-center gap-2.5 font-display font-black text-[#0b1d3a] dark:text-white">
				<span class="grid size-9 place-items-center rounded-xl bg-gradient-to-br from-[#0b3d91] to-[#1e63d6] text-white">
					<ShipIcon class="size-5" />
				</span>
