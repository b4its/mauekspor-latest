...
<AppShell title="Business Profile" eyebrow={t('Buat identitas UMKM')}>
	<Card class="panel-hero p-6 md:p-8">
		<CardHeader class="p-0">
			...
			<CardTitle class="mt-3 font-display text-4xl font-black tracking-tight text-[#0b1d3a] md:text-5xl dark:text-white">{t('Daftarkan bisnis di balik produk Anda.')}</CardTitle>
